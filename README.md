...
## Background: from manual design to automation

This project began as a manual, hand-iterated structural design exercise — sizing a wing spar in Excel by adjusting dimensions until the stress and torsion checks passed, then building and physically load-testing the result. That original project is documented here:

**[▶ Original manual Wing Spar Design — physical build & load test](https://youtu.be/0Efimh8G1TI?si=opNGgLY5TrZkc-P6)**

Every constraint and validation check in this automated MATLAB version (bending stress, torsional compliance, geometric fit, physical safety margin) traces directly back to lessons learned building and testing that first version by hand.
